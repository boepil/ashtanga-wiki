...
## The Structure of Aum

The syllable is composed of three distinct phonetic components (A, U, M) and a fourth silent component:
- **A (Ah)**: Represents the waking state, the gross material world, and creation.
- **U (Oo)**: Represents the dream state, the subtle or mental world, and preservation.
- **M (Mm)**: Represents the state of deep sleep, the causal world, and dissolution.
- **The Silence (Turiya)**: The vibration that follows the chant represents the fourth state, the pure consciousness that observes the other three states.
...
- *Mandukya Upanishad* [via NotebookLM Yoga Philosophy and Origins]
- K. Pattabhi Jois, *Yoga Mala* [via NotebookLM Yoga Philosophy and Origins]
- `raw/07_PHILOSOPHY/Classical_Texts/Key_Sanskrit_Terms.md`
